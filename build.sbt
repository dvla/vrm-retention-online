...
lazy val vrmRetentionEligibilityProject = vrmRetentionEligibility("0.21").disablePlugins(PlayScala, SbtWeb)
lazy val vrmRetentionRetainProject = vrmRetentionRetain("0.23").disablePlugins(PlayScala, SbtWeb)
