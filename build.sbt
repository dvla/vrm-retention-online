...
lazy val vrmRetentionEligibilityProject = vrmRetentionEligibility("0.10").disablePlugins(PlayScala, SbtWeb)
lazy val vrmRetentionRetainProject = vrmRetentionRetain("0.10").disablePlugins(PlayScala, SbtWeb)
