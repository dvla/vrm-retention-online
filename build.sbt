...
lazy val vrmRetentionEligibilityProject = vrmRetentionEligibility("0.14").disablePlugins(PlayScala, SbtWeb)
lazy val vrmRetentionRetainProject = vrmRetentionRetain("0.15").disablePlugins(PlayScala, SbtWeb)
