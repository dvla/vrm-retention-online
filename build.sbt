...
lazy val vrmRetentionEligibilityProject = vrmRetentionEligibility("0.16").disablePlugins(PlayScala, SbtWeb)
lazy val vrmRetentionRetainProject = vrmRetentionRetain("0.17").disablePlugins(PlayScala, SbtWeb)
