...
lazy val vrmRetentionEligibilityProject = vrmRetentionEligibility("0.20-SNAPSHOT").disablePlugins(PlayScala, SbtWeb)
lazy val vrmRetentionRetainProject = vrmRetentionRetain("0.21-SNAPSHOT").disablePlugins(PlayScala, SbtWeb)
