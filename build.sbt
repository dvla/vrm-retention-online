...
lazy val vrmRetentionEligibilityProject = vrmRetentionEligibility("0.12-SNAPSHOT").disablePlugins(PlayScala, SbtWeb)
lazy val vrmRetentionRetainProject = vrmRetentionRetain("0.12-SNAPSHOT").disablePlugins(PlayScala, SbtWeb)
