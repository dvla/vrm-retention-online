...
lazy val vrmRetentionEligibilityProject = vrmRetentionEligibility("0.18").disablePlugins(PlayScala, SbtWeb)
lazy val vrmRetentionRetainProject = vrmRetentionRetain("0.19").disablePlugins(PlayScala, SbtWeb)
