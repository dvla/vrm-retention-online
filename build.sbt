...
lazy val vrmRetentionEligibilityProject = vrmRetentionEligibility("0.19").disablePlugins(PlayScala, SbtWeb)
lazy val vrmRetentionRetainProject = vrmRetentionRetain("0.20").disablePlugins(PlayScala, SbtWeb)
