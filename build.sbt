...
lazy val vrmRetentionEligibilityProject = vrmRetentionEligibility("0.17-SNAPSHOT").disablePlugins(PlayScala, SbtWeb)
lazy val vrmRetentionRetainProject = vrmRetentionRetain("0.18-SNAPSHOT").disablePlugins(PlayScala, SbtWeb)
