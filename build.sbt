...
libraryDependencies ++= {
  ...
  Seq(
    ...
    "dvla" %% "vehicles-presentation-common" % "2.7.1-SNAPSHOT" withSources() withJavadoc() exclude("junit", "junit-dep"),
    "dvla" %% "common-test" % "2.7.1-SNAPSHOT" % "test" withSources() withJavadoc(),
