...
lazy val vrmRetentionEligibilityProject = vrmRetentionEligibility("0.9").disablePlugins(PlayScala, SbtWeb)
lazy val vrmRetentionRetainProject = vrmRetentionRetain("0.8").disablePlugins(PlayScala, SbtWeb)
