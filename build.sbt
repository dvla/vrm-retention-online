...
lazy val vrmRetentionEligibilityProject = vrmRetentionEligibility("0.22").disablePlugins(PlayScala, SbtWeb)
lazy val vrmRetentionRetainProject = vrmRetentionRetain("0.24").disablePlugins(PlayScala, SbtWeb)
