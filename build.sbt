...
lazy val vrmRetentionEligibilityProject = vrmRetentionEligibility("0.22-SNAPSHOT").disablePlugins(PlayScala, SbtWeb)
lazy val vrmRetentionRetainProject = vrmRetentionRetain("0.24-SNAPSHOT").disablePlugins(PlayScala, SbtWeb)
