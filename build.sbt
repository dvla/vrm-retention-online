...
lazy val vrmRetentionEligibilityProject = vrmRetentionEligibility("0.23").disablePlugins(PlayScala, SbtWeb)
lazy val vrmRetentionRetainProject = vrmRetentionRetain("0.26").disablePlugins(PlayScala, SbtWeb)
