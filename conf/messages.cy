...
vrm_retention_beforeyoustart.p6 = Ar ôl i chi gadw’ch rhif cofrestru gallwch un ai:
vrm_retention_beforeyoustart.p6.listitem1 = ei roi ar gerbyd newydd neu ail law, neu
vrm_retention_beforeyoustart.p6.listitem2 = ei gadw ar dystysgrif hyd nes i chi fod eisiau ei roi ar gerbyd arall.
...
vrm_retention_beforeyoustartpart2.title = Telerau ar gyfer cadw rhif cofrestru
vrm_retention_beforeyoustartpart2.p1 = Rhaid i’r cerbyd:
vrm_retention_beforeyoustartpart2.p1.listitem1 = fod wedi ei gofrestru â’r DVLA
...
vrm_retention_beforeyoustartpart2.p1.listitem4 = wedi ei drethu yn awr neu o fewn y 5 mlynedd diwethaf.
vrm_retention_beforeyoustartpart2.p2 = Dim ond drwy ddefnyddio ein gwasanaeth ar-lein ac o’r rhagddodiad ‘R’ y gallwch chi gadw rhif cofrestru personol.
vrm_retention_beforeyoustartpart2.p4 = os nad yw wedi ei drethu, rhaid datgan HOS yn barhaus ers y dyddiad olaf iddo gael ei drethu.
vrm_retention_beforeyoustartpart2.button = Dechreuwch yn awr
...
vehicle-lookup-failure-direct-to-paper-p1a = Rhaid i chi
direct-to-paper-text-v317 = gwblhau a chyflwyno ffurflen V317
vehicle-lookup-failure-direct-to-paper-p1b = ar gyfer:
...
vrm_retention_eligibility_vic_failure = Dengys ein cofnodion fod y cerbyd hwn angen gwiriad adnabod cerbyd (VIC). Ceir mwy o wybodaeth yn
vrm_retention_eligibility_vic_failure_link = https://www.gov.uk/vehicle-identity-check
vrm_retention_eligibility_no_keeper_failure = Dengys ein cofnodion nad oes ceidwad cofrestredig ar gyfer y cerbyd hwn.  Ceir gwybodaeth bellach ar sut i ddiweddaru manylion ceidwad yn
vrm_retention_eligibility_no_keeper_failure_link = https://www.gov.uk/vehicle-registration-certificate-v5c-log-book
vrm_retention_eligibility_not_mot_failure = Dengys ein cofnodion nad yw’r cerbyd hwn o fath sydd angen MOT neu cawsom wybod nad yw ei ddefnydd yn gofyn am MOT.  Ni allwch gymryd y rhif cofrestru hwn oddi ar y cerbyd hwn.
vrm_retention_eligibility_pre_1998_failure = Gan fod eich cerbyd wedi ei gofrestru cyn 1998, ni allwn ar hyn o bryd gyhoeddi rhif cofrestru arall yn awtomatig.  Bydd angen i chi anfon eich cais i’r DVLA i’w brosesu.
vrm_retention_eligibility_q_plate_failure = Ni allwch gymryd rhif cofrestru i ffwrdd sydd wedi ei gofrestru gyda rhif cofrestru Q.
...
vrm_retention_vehicle_callback.title = Manylion y cerbyd
vrm_retention_vehicle_callback.regNumLabel = Rhif Cofrestru:
vrm_retention_vehicle_callback.makeLabel = Gwneuthuriad:
...
email.line8 = Rydym wedi anfon manylion y rhif cofrestru newydd atoch hefyd, gyda’r manylion isod, ynghyd â PDF o’r llythyr awdurdodi (V948) y gallwch ei lawrlwytho neu ei argraffu gan ddefnyddio’r ddolen a ddarparwyd.
email.line9 = Cofrestriad newydd
email.line10 = Mae’r cerbyd wedi ei ddynodi â’r rhif cofrestru newydd canlynol:
email.line12 = I gynhyrchu’r plât cofrestru ar gyfer y rhif cofrestru newydd a ddyranwyd, byddwch angen llythyr awdurdodi ar gyfer cofrestriad newydd (V948).
...
vrm_retention_failure.title = Trafodion yn aflwyddiannus
vrm_retention_failure.text = Ni fu’r trafodion yn llwyddiannus, ni chymerwyd unrhyw daliad ac ni wnaed unrhyw newid i fanylion y cerbyd.
