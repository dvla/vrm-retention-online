...
onHandlerNotFound.body = Ni ellir dod o hyd i’r dudalen rydych wedi gwneud cais amdani, mae’r digwyddiad hwn wedi cael ei gofnodi er mwyn ei ymchwilio.
...
vrm_retention_beforeyoustartpart2.title = Yr amodau ar gyfer cadw rhif cofrestru
vrm_retention_beforeyoustartpart2.p1 = Mae’n rhaid bod y cerbyd:
vrm_retention_beforeyoustartpart2.p1.listitem1 = wedi ei gofrestru â’r DVLA
vrm_retention_beforeyoustartpart2.p1.listitem2 = ar gael i’w archwilio
vrm_retention_beforeyoustartpart2.p1.listitem3 = o fath sydd angen tystysgrif prawf MOT neu brawf cerbyd nwyddau trwm (HGV)
vrm_retention_beforeyoustartpart2.p1.listitem4 = wedi ei drethu ar hyn o bryd neu o fewn y 5 mlynedd diwethaf.
vrm_retention_beforeyoustartpart2.p2 = Gallwch gadw cofrestriad personol gan ddefnyddio ein gwasanaeth arlein o’r rhagddodiad ‘R’ ymlaen yn unig.
vrm_retention_beforeyoustartpart2.p4 = Os nad yw’r cerbyd wedi ei drethu, mae’n rhaid datgan HOS yn barhaus ers dyddiad dod i ben y dreth.
vrm_retention_beforeyoustartpart2.button = Dechrau nawr

# set-up business details
vrm_retention_setupbusinessdetails.title = Rhowch eich manylion busnes
business-name = Enw busnes
vrm_retention_setupbusinessdetails.businessnamelabel = Enw busnes
vrm_retention_setupbusinessdetails.businessnamehelper = Enw’r unigolyn sy’n cwblhau’r trafodyn hwn
contact-name = Enw cyswllt
vrm_retention_setupbusinessdetails.businesscontactlabel = Enw cyswllt
contact-email = Cyfeiriad ebost
vrm_retention_setupbusinessdetails.businessemaillabel = Cyfeiriad ebost
...
# vehicle Lookup
vrm_retention_vehiclelookup.title = Rhowch fanylion
vrm_retention_vehiclelookup.v5c = Tystysgrif gofrestru V5CW (llyfr log)
vrm_retention_vehiclelookup.refnumlabel = Rhif diweddaraf cyfeirnod dogfen dystysgrif gofrestru V5CW (llyfr log)
vrm_retention_vehiclelookup.refnumHint = Y rhif 11 digid heb fylchau sydd ar y dystysgrif gofrestru V5CW (llyfr log)
vrm_retention_vehiclelookup.vrninputlabel = Rhif cofrestru yr ydych eisiau cymryd oddi ar y cerbyd
...
vehicle-lookup-failure.p1 = Mae’r rhif cofrestru cerbyd a/neu rif cyfeirnod y dystysgrif gofrestru V5CW (llyfr log) sydd wedi’u rhoi naill ai’n anghywir neu nid yw oddi ar y V5CW ddiweddarach a gyhoeddwyd am y cerbyd hwn.
vehicle-lookup-failure.p2 = Gwiriwch os gwelwch yn dda bod y rhif cofrestru cerbyd a’r rhif cyfeirnod y dystysgrif gofrestru V5CW (llyfr log) yn gywir a dewisiwch y botwm ‘Ceisiwch eto’ isod.
...
vehicle-lookup-failure-direct-to-paper-p2 = Mae’n rhaid i’r holl ddogfennau fod yn rhai gwreiddiol; nid llungopïau na chopïau ffacs.
...
vrm_retention_payment.p2 = Cardiau Maestro, Visa debyd, Mastercard debyd, cardiau debyd Electron, VISA a chardiau credyd Mastercard yn unig a dderbynnir.
vrm_retention_paymentfailure.tryagainbutton = Rhowch gynnig arall arni
vrm_retention_paymentfailure.exitbutton = Gadael
vrm_retention_paymentnotauthorised.tryagainbutton = Rhowch gynnig arall arni
vrm_retention_paymentnotauthorised.exitbutton = Gadael
...
# confirm view
vrm_retention_confirm.title = Cadarnhau manylion y ceidwad
...
vrm_retention_confirm.businessEmailLabel = Cyfeiriad ebost
...
vrm_retention_success.subtitle = Gallwn ei dynnu oddi ar y cerbyd nawr
vrm_retention_success.yourCert = Rhif eich tystysgrif gadw yw:
success-cert-warning = Rydym yn argymell yn gryf i chi gadw eich rhif tystysgrif yn gyfrinachol hyd nes bod y rhif cofrestru yn barod i’w werthu neu ei aseinio i gerbyd.
success-cert-warning-1 = Bydd eich treth gerbyd gyfredol a thystysgrif MOT yn parhau’n ddilys hyd nes y dyddiad dod i ben. Ni fydd y DVLA yn anfon tystysgrif MOT newydd atoch.
success-replacement-registration-number = eich rhif cofrestru newydd yw:
vrm_retention_success.newPlateLink = Lawrlwythwch yr eV948
...
vrm_retention_success.p3 = at y ceidwad yn ei gyfeiriad cofrestredig.
...
success-keeper-application-details-monday-to-friday = Dydd llun i Ddydd Gwener: 8am i 6pm
success-keeper-application-details-saturday = Dydd Sadwrn: 8am i 2pm
...
vrm_retention_leave_feedback.p1 = A fyddech cystal â’n helpu ni i wella’r gwasanaeth hwn drwy

email.withoutHtml = Nid yw’ch cleient ebost yn cefnogi negeseuon HTML.
email.title = Tynnu rhif cofrestru oddi ar gerbyd wedi’i gwblhau ar gyfer {0}
...
email.line9 = Rhif cofrestru newydd
email.line10 = Mae’r cerbyd wedi ei aseinio â’r rhif cofrestru newydd canlynol:
email.line12 = I greu’r plâtiau rhif ar gyfer y rhif cofrestru newydd sydd wedi’i aseinio, bydd angen arnoch lythyr awdurdodiad ar gyfer rhif cofrestru newydd (V948).
...
email.line22 = Bydd y canlynol yn cael eu hanfon at y ceidwad cofrestredig:
email.line23 = Tystysgrif gofrestru cerbyd V5CW (llyfr log) newydd yn dangos y rhif cofrestru newydd
email.line24 = Bydd eich treth gerbyd gyfredol a thystysgrif MOT yn parhau’n ddilys hyd nes y dyddiad dod i ben. Ni fydd y DVLA yn anfon tystysgrif MOT newydd atoch.
email.line25 = Tystysgrif gadw ar gyfer y rhif cofrestru a gadwyd
email.line28 = Gallwch aseinio eich rhif cofrestru arlein drwy ddefnyddio eich dynodiad tystysgrif gadw yn:
...
vrm_retention_timeout.p-1 = Mae oedi wrth brosesu’ch cais.
vrm_retention_timeout.p-2 = Byddwn yn rhoi gwybod i chi drwy ebost pan brosesir eich cais.
...
# email
email.template.subject = Derbynneb taliad ar gyfer cadw
