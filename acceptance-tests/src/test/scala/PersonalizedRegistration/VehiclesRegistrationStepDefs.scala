...
final class VehiclesRegistrationStepDefs(webBrowserDriver: WebBrowserDriver) extends ScalaDsl with EN with WebBrowserDSL with Matchers {
  ...
  def i_enter_invalid_data_in_the_and_fields(arg0: String, arg1: String, arg2: String) {
  ...
  def i_enter_data_in_the_and_that_does_not_match_a_valid_vehicle_record_three_times_in_a_row(arg0: String, arg1: String, arg2: String) {
