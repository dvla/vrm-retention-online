...
final class BusinessChooseYourAddressIntegrationSpec extends UiSpec with TestHarness {
  ...
  "go to page" should {
    ...
    "redirect when no businessName is cached" taggedAs UiTag in new WebBrowserForFirefox {
      go to BusinessChooseYourAddressPage

      currentUrl should equal(VehicleLookupPage.url)
    }

    "not display 'No addresses found' message when address service returns addresses" taggedAs UiTag in new WebBrowserForFirefox {
      go to BeforeYouStartPage
      cacheSetup()
      go to BusinessChooseYourAddressPage
    ...
    "should display the postcode entered in the previous page" taggedAs UiTag in new WebBrowserForFirefox {
      go to BeforeYouStartPage
      cacheSetup()
      go to BusinessChooseYourAddressPage
    ...
    "display expected addresses in dropdown when address service returns addresses" taggedAs UiTag in new WebBrowserForFirefox {
      go to BeforeYouStartPage
      cacheSetup()
      go to BusinessChooseYourAddressPage
  ...
  "back button" should {
    "display previous page" taggedAs UiTag in new WebBrowserForFirefox {
      go to BeforeYouStartPage
      cacheSetup()
      go to BusinessChooseYourAddressPage
  ...
  "select button" should {
    ...
    "go to the next page when correct data is entered" taggedAs UiTag in new WebBrowserForFirefox {
      go to BeforeYouStartPage
      cacheSetup()
      happyPath
    ...
    "display validation error messages when addressSelected is not in the list" taggedAs UiTag in new WebBrowserForFirefox {
      go to BeforeYouStartPage
      cacheSetup()
      sadPath
    ...
    "remove redundant EnterAddressManually cookie (as we are now in an alternate history)" taggedAs UiTag in new WebBrowserForFirefox {
      go to BeforeYouStartPage
