...
import composition.webserviceclients.bruteforceprevention.{BruteForcePreventionServiceBinding, TestBruteForcePreventionWebService}
...
import composition.webserviceclients.vrmretentioneligibility.{TestVRMRetentionEligibilityWebService, VRMRetentionEligibilityServiceBinding}
import composition.webserviceclients.vrmretentionretain.{TestVrmRetentionRetainWebService, VrmRetentionRetainServiceBinding}
